<div class="nav z-10 fixed w-full h-max px-2 text-center bottom-0 md:w-48 md:pt-8 md:top-0 md:left-0 md:h-screen">
    <div class="md:relative md:h-full mx-auto">
      {{-- @include('layouts.navigation') --}}
      {{-- @livewire('layouts.navigation') --}}

      <div class="flex flex-col md:h-full" x-data="{isOpen: false}">
        <div class="flex grow md:hidden mt-2 bg-white border-solid border-y border-gray-400 w-full">

          <div x-show="isOpen" class="text-sm mx-6 my-2.5 px-2.5 flex flex-col w-full" x-cloak>

            <div class="flex flex-col items-center w-full text-center bg-gray-400">
            ...
            <div class="flex flex-col" style="">
              @include('layouts.partials.navigation-submenu')
        ...
        <div class="hidden md:flex md:flex-col md:items-center md:bg-gray-400 w-full">
          {{-- <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg> --}}
          <svg class="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 329.249 329.249" xmlns="http://www.w3.org/2000/svg">                    
            <g id="XMLID_7_">
              <g id="XMLID_62_">
          ...
          <div class="flex-1 md:h-full p-2">
            <ul class="list-reset flex flex-row align-left md:flex-col text-center md:text-left">
              <li class="md:mr-3 flex-1 w-full">
                <a href="{{ route('dashboard') }}" class="flex md:flex-row flex-col items-center py-1 md:py-3 pl-1 align-middle text-gray-600 no-underline rounded hover:bg-gray-800 hover:text-white {{ request()->routeIs('dashboard') ? 'bg-gray-200' : ''  }}">
              ...
              <li class="md: mr-3 flex-1 w-full">
                <a href="{{ route('footprints') }}" class="flex md:flex-row flex-col items-center py-1 md:py-3 pl-1 align-middle text-gray-600 no-underline rounded hover:bg-gray-800 hover:text-white {{ request()->routeIs('footprints') ? 'bg-gray-200' : ''  }}">
                  ...
                  <span class="block md:inline-block pb-1 md:pb-0 text-xs md:text-base">My Footprints</span>
                </a>
              </li>
              <li class="md: mr-3 flex-1 w-full">
                <a href="#" class="flex md:flex-row flex-col items-center py-1 md:py-3 pl-1 align-middle text-gray-600 no-underline rounded hover:bg-gray-800 hover:text-white {{ request()->routeIs('requests') ? 'bg-gray-200' : ''  }}">
                  <svg class="fill-current h-6 w-6 md:mr-3"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 512 512"
                  ...
                  <span class="block md:inline-block pb-1 md:pb-0 text-xs md:text-base">My Requests</span>
                </a>
              </li>
            </ul>
            <div class="hidden md:flex bg-gray-800 border border-gray-800 mx-4 my-2"></div>
            <div class="hidden md:flex">
              @include('layouts.partials.navigation-submenu')
            </div>  
          </div>
          <div class="flex text-center md:text-left md:w-full md:mt-auto md:mb-2 p-2 rounded hover:bg-gray-800 hover:text-white ">
            <div class="flex md:hidden w-full h-full">
              ...
              <button
                ...
                {{-- <span class="block md:inline-block pb-1 md:pb-0 text-xs md:text-base">you</span> --}}
              </button>
            </div>
            ...
            <div class="hidden md:block w-full"
              x-data="{open: false}" >
              <div class="flex items-center justify-between hover:bg-gray-800 hover:text-white cursor-pointer py-2.5 px-4 rounded"
                @click="open = !open" >
